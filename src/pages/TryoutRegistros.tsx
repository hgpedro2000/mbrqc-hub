        ...
        <div className="container mx-auto px-3 md:px-4 py-4 md:py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 md:gap-3">
              <Button variant="ghost" onClick={() => navigate("/tryout")} className="header-btn header-btn-back"><ArrowLeft className="w-4 h-4 md:mr-1" /> <span className="hidden md:inline">{t("common.back")}</span></Button>
