    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 max-w-6xl w-full overflow-x-clip">
        <Tabs defaultValue="usuarios" className="space-y-4 sm:space-y-6 w-full min-w-0">
          <div className="sticky top-0 z-30 w-full overflow-x-auto -mx-3 px-3 sm:mx-0 sm:px-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/70 py-2 border-b border-border">
