                    ...
                    {defects.map((defect: any, idx: number) => (
                      <div key={idx} className="border border-border rounded-lg p-4 bg-card">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <Badge variant="secondary" className="h-7 px-3 inline-flex items-center justify-center leading-none text-xs font-semibold whitespace-nowrap">
                            Defeito #{idx + 1}
                          </Badge>

                          {defect.needs_improvement && (
                            <Badge variant="destructive" className="h-7 px-3 inline-flex items-center justify-center leading-none text-xs font-semibold whitespace-nowrap">Melhoria necessária</Badge>
                          )}
                          {defect.improvement_category && (
                            <Badge variant="secondary" className="h-7 px-3 inline-flex items-center justify-center leading-none text-xs font-semibold whitespace-nowrap">Cat. {defect.improvement_category}</Badge>
                          )}
                        </div>
